...
class NeuralImageFunction(torch.nn.Module):
    ...
    def define_network(self, opt):
        ...
        self.siren = Siren(in_features=input_2D_dim, out_features=3, hidden_features=256,
                           hidden_layers=len(opt.arch.layers) - 1, outermost_linear=True,
